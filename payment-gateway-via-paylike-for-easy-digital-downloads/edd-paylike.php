...
define( 'EDD_PAYLIKE_VERSION', '1.2.0' );
/**
 * Plugin activation
 * @access      public
 * @since       1.0.0
	...
	<fieldset id="edd_cc_fields">
		...
		<p id="edd-card-number-wrap">
			...
			<input type="text" pattern="[0-9]{4}  [0-9]{4}  [0-9]{4}  .*" id="card_number"
			       class="card-number edd-input required" placeholder="0000 0000 0000 0000" required/>
		</p>
		<p id="edd-card-cvc-wrap">
			...
			<input type="text" pattern="[0-9]{3,4}" size="4" autocomplete="off" id="card_cvc"
		...
		<p class="card-expiration">
			...
			<input type="text" id="card-expiry" class="card-expiry edd-input required" placeholder="MM  /  YY"
